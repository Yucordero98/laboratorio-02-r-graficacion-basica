...
ca_covid19.confirmado <- ca_covid19[confirmados.ordenado,]
...
```{r}
casosactivos.ordenado <- order(ca_covid19$activos, decreasing=TRUE)

ca_covid19.casosactivos <- ca_covid19[casosactivos.ordenado,]
